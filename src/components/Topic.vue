<template>
  <div class="media" v-if="topic">
    <div class="media-left">
      <a href="#">
        <img v-bind:src="auth.user.profile.avatar" class="media-object" />
      </a>
    </div>
    ...
    <div class="media-body">
      ...
      <p>
        Posted by {{ topic.user.data.username }} {{ topic.diffForHumans}}
      </p>

      <p v-html="topic.body | marked">
      ...
      <div class="media" v-for="post in topic.posts.data" >
          ...
          <div class="media-body">
            <p>
              Posted by {{ post.user.data.username }} {{ post.diffForHumans }}
            </p>

            <p v-html="post.body | marked ">
